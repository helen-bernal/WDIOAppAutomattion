...
public class LoginScreen extends BaseScreen {
    ...
    private static final String uiAutomator_SuccessLogin = "new UiSelector().className(\"android.widget.FrameLayout\").instance(0)";
    @AndroidFindBy(uiAutomator = uiAutomator_SuccessLogin)
    private WebElement successLoginText;

    private static final String uiAutomator_UserLoginButton = "new UiSelector().description(\"button-LOGIN\")";
    @AndroidFindBy(uiAutomator = uiAutomator_UserLoginButton)
    private WebElement successLoginButtom;
}
